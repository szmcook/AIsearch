...
# make a list of the unvisited cities
citiesNotVisited = []
for i in range(num_cities):
    if i not in tour:
        citiesNotVisited.append(i)
print("citiesNotVisited: {}".format(citiesNotVisited))

while (len(tour) < num_cities):
    # pick one of the cities
    newCity = random.choice(citiesNotVisited)
    citiesNotVisited.remove(newCity)
    tour.append(newCity)
...
# tour length should be the sum of the distances.
tour_length = 0
